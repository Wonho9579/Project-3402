...
![Step 2 Preview](./project_images/step2_data_preview_2.PNG)
![Step 2 Preview](./project_images/step2_data_preview.PNG)


> These previews confirm the structure and cleanliness of the dataset.  
> The first part shows a snapshot of the top 5 rows to help others understand the input format.  
> The second part displays the data types and confirms there are no missing values in any column.
> The third part presents summary statistics for each numerical feature, helping identify ranges and justify the use of scaling during preprocessing.
