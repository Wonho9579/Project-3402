...
> The second image displays the data types and confirms there are no missing values in any column.
> The third image presents summary statistics for each numerical feature, helping identify ranges and justify the use of scaling during preprocessing.
